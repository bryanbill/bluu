...
class Bloc extends Object with ValueTransformer implements BaseBloc {
  ...
  var _canvasController = BehaviorSubject<String>();
  ...
  Function(String) get sinkCanvas => _canvasController.sink.add;
  Stream<String> get recieveStatus =>
      _radioController.stream.transform(transformValue);

  Stream<String> get canvasColorValue => _canvasController.stream;
